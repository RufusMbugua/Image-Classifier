...
```
git clone https://github.com/rufusmbugua/Image-Classifier/
```
...
Please read [CONTRIBUTING.md](CONTRIBUTING) for the process for submitting pull requests. 

## Authors

* **Rufus Mbugua** - *Initial work* 
